...
docker buildx build -t tonyahu/rehab-ai:c5b-latest --platform=linux/amd64 -f ../src/c5-test-frontend/rehab-ai/Dockerfile
...
docker push tonyahu/rehab-ai:c5b-latest
...
docker tag tonyahu/rehab-ai:c5b-latest us-central1-docker.pkg.dev/ac215-399020/vertex-ai-pipeline/c5b-front-end:latest
...
docker push us-central1-docker.pkg.dev/ac215-399020/vertex-ai-pipeline/c5b-front-end:latest
