...
echo "Executing c1-buil-tag-push script."
...
docker buildx build -t tonyahu/rehab-ai:c1-latest --platform=linux/amd64 -f ../src/c1-data-scraping/Dockerfile .
...
docker tag tonyahu/rehab-ai:c1-latest us-central1-docker.pkg.dev/ac215-399020/vertex-ai-pipeline/c1-data-scraping:latest
...
docker push us-central1-docker.pkg.dev/ac215-399020/vertex-ai-pipeline/c1-data-scraping:latest
