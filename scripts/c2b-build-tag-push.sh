...
docker buildx build -t tonyahu/rehab-ai:c2b-latest --platform=linux/amd64 -f ../src/c2-preprocessing/Dockerfile .
...
docker tag tonyahu/rehab-ai:c2b-latest us-central1-docker.pkg.dev/ac215-399020/vertex-ai-pipeline/c2-preprocessing:latest
...
docker push us-central1-docker.pkg.dev/ac215-399020/vertex-ai-pipeline/c2-preprocessing:latest
