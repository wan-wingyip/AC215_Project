...
docker buildx build -t tonyahu/rehab-ai:c2-latest --platform=linux/amd64 -f ../src/c2-data-labeling/Dockerfile .
...
docker tag tonyahu/rehab-ai:c2-latest us-central1-docker.pkg.dev/ac215-399020/vertex-ai-pipeline/c2-data-labeling:latest
...
docker push us-central1-docker.pkg.dev/ac215-399020/vertex-ai-pipeline/c2-data-labeling:latest
